    ...
    <div className="app">
      ...
      <aside className={`sidebar${sidebarOpen ? ' open' : ''}`}>
        ...
        <div className="mode-toggle">
          <button className={!mode ? 'active' : ''} onClick={() => setMode(null)}>
          ...
          <button className={mode === 'compare' ? 'active' : ''} onClick={() => setMode('compare')}>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="8" height="18" rx="1"/><rect x="14" y="3" width="8" height="18" rx="1"/></svg>
            Compare
          </button>
          <button className={mode === 'compare3d' ? 'active' : ''} onClick={() => setMode('compare3d')}>
